...
public class RegexMatch {
	public static void main(String[] args) {
		...
		RegexMatch.matchIt("lamiaewahabi@hotmail.es", regex);
		RegexMatch.matchIt("d@c", regex);
		RegexMatch.matchIt("meriam@hotmail.es", regex);
		RegexMatch.matchIt("8@7", regex);
		RegexMatch.matchIt("deno@deno", regex);
